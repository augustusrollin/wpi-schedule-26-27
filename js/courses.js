...
const TYPE_META = {
  ...
  HU39: { label:'HU Inquiry Seminar',     color:'#6C3483', text:'#fff' },
...
const COURSES = {
  ...
  // ── HUMANITIES INQUIRY SEMINARS (HU 3900 / HU 3910) — Spring 2027 C Term ──
  // HU 3900 — Inquiry Seminars
  HU3900_C01: {
    id:'HU3900_C01', code:'HU 3900', type:'HU39', credits:1,
    name:'INQ SEM: DDT, Silent Spring, Am Env',
    description:'Cat. I. This seminar serves as the culmination for a student\'s Humanities and Arts Requirement, providing opportunities for sustained critical inquiry. Explores DDT, Silent Spring, and American environmentalism.',
    prerequisites:[],
    sections:{ C:[{ section:'C01', professor:'Joseph Cullon', days:['W'], start:'12:00', end:'13:50', location:'Kaven Hall 204', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3900_C01B: {
    id:'HU3900_C01B', code:'HU 3900', type:'HU39', credits:1,
    name:'INQ SEM: McKim, Mead & White & Amer Arch 1870–1929',
    description:'Cat. I. This seminar serves as the culmination for a student\'s Humanities and Arts Requirement. Examines the architectural legacy of McKim, Mead & White and American architecture 1870–1929.',
    prerequisites:[],
    sections:{ C:[{ section:'C01', professor:'David Samson', days:['T'], start:'14:00', end:'15:50', location:'Salisbury Labs 124 Conference Room', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3900_C02: {
    id:'HU3900_C02', code:'HU 3900', type:'HU39', credits:1,
    name:'INQ SEM: Jazz History Database',
    description:'Cat. I. This seminar serves as the culmination for a student\'s Humanities and Arts Requirement. Explores the history of jazz through database research and critical inquiry.',
    prerequisites:[],
    sections:{ C:[{ section:'C02', professor:'Ben Young', days:['M'], start:'12:00', end:'13:50', location:'Alden Hall B06 Janet Earle Room', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3900_C02B: {
    id:'HU3900_C02B', code:'HU 3900', type:'HU39', credits:1,
    name:'INQ SEM: Philosophy (TBA)',
    description:'Cat. I. This seminar serves as the culmination for a student\'s Humanities and Arts Requirement. Specific philosophical theme to be announced.',
    prerequisites:[],
    sections:{ C:[{ section:'C02', professor:'TBA', days:['R'], start:'13:00', end:'14:50', location:'Salisbury Labs 124 Conference Room', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3900_C04: {
    id:'HU3900_C04', code:'HU 3900', type:'HU39', credits:1,
    name:'INQ SEM: Literature and the Environment',
    description:'Cat. I. This seminar serves as the culmination for a student\'s Humanities and Arts Requirement. Explores literary representations of the environment and ecological themes.',
    prerequisites:[],
    sections:{ C:[{ section:'C04', professor:'TBA', days:['W'], start:'10:00', end:'11:50', location:'Salisbury Labs 226 HUA Seminar Room', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3900_C05: {
    id:'HU3900_C05', code:'HU 3900', type:'HU39', credits:1,
    name:'INQ SEM: Integrating Humanities in STEM Education',
    description:'Cat. I. This seminar serves as the culmination for a student\'s Humanities and Arts Requirement. Explores integrating humanistic inquiry within STEM disciplines.',
    prerequisites:[],
    sections:{ C:[{ section:'C05', professor:'TBA', days:[], start:null, end:null, location:'TBD', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3900_C08: {
    id:'HU3900_C08', code:'HU 3900', type:'HU39', credits:1,
    name:'INQ SEM: Biographies in Twentieth-Century Technoscience',
    description:'Cat. I. This seminar serves as the culmination for a student\'s Humanities and Arts Requirement. Examines biographical approaches to understanding twentieth-century science and technology.',
    prerequisites:[],
    sections:{ C:[{ section:'C08', professor:'David Spanagel', days:['W'], start:'14:00', end:'15:50', location:'Salisbury Labs 226 HUA Seminar Room', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3900_C09: {
    id:'HU3900_C09', code:'HU 3900', type:'HU39', credits:1,
    name:'INQ SEM: Holocaust and Memory',
    description:'Cat. I. This seminar serves as the culmination for a student\'s Humanities and Arts Requirement. Examines the Holocaust through the lens of memory, testimony, and historical inquiry.',
    prerequisites:[],
    sections:{ C:[{ section:'C09', professor:'Emily Gioielli', days:['R'], start:'15:00', end:'16:50', location:'Salisbury Labs 124 Conference Room', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3900_C11: {
    id:'HU3900_C11', code:'HU 3900', type:'HU39', credits:1,
    name:'INQ SEM: Native American History',
    description:'Cat. I. This seminar serves as the culmination for a student\'s Humanities and Arts Requirement. Explores Native American history, culture, and contemporary issues.',
    prerequisites:[],
    sections:{ C:[{ section:'C11', professor:'TBA', days:['F'], start:'12:00', end:'13:50', location:'TBD', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3900_C14: {
    id:'HU3900_C14', code:'HU 3900', type:'HU39', credits:1,
    name:'INQ SEM: History of Silicon Valley',
    description:'Cat. I. This seminar serves as the culmination for a student\'s Humanities and Arts Requirement. Traces the cultural, economic, and technological history of Silicon Valley.',
    prerequisites:[],
    sections:{ C:[{ section:'C14', professor:'Whitney McIntosh', days:['R'], start:'14:00', end:'15:50', location:'Salisbury Labs 226 HUA Seminar Room', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3900_C15: {
    id:'HU3900_C15', code:'HU 3900', type:'HU39', credits:1,
    name:'INQ SEM: Queerly Religious',
    description:'Cat. I. This seminar serves as the culmination for a student\'s Humanities and Arts Requirement. Examines intersections of queer identity and religious practice.',
    prerequisites:[],
    sections:{ C:[{ section:'C15', professor:'Rebecca Moody', days:['T'], start:'14:00', end:'15:50', location:'Salisbury Labs 226 HUA Seminar Room', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3900_C16: {
    id:'HU3900_C16', code:'HU 3900', type:'HU39', credits:1,
    name:'INQ SEM: Loaded Language',
    description:'Cat. I. This seminar serves as the culmination for a student\'s Humanities and Arts Requirement. Explores how language carries ideological, political, and cultural weight.',
    prerequisites:[],
    sections:{ C:[{ section:'C16', professor:'TBA', days:['F'], start:'12:00', end:'13:50', location:'TBD', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3900_C17: {
    id:'HU3900_C17', code:'HU 3900', type:'HU39', credits:1,
    name:'INQ SEM: Environmental Philosophy',
    description:'Cat. I. This seminar serves as the culmination for a student\'s Humanities and Arts Requirement. Examines philosophical questions about nature, ecology, and environmental ethics.',
    prerequisites:[],
    sections:{ C:[{ section:'C17', professor:'Roger Gottlieb', days:['T'], start:'12:00', end:'13:50', location:'Salisbury Labs 124 Conference Room', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3900_C18: {
    id:'HU3900_C18', code:'HU 3900', type:'HU39', credits:1,
    name:'INQ SEM: Human Performance in Exercise and Sport',
    description:'Cat. I. This seminar serves as the culmination for a student\'s Humanities and Arts Requirement. Explores humanistic dimensions of athletic performance, sport culture, and exercise science.',
    prerequisites:[],
    sections:{ C:[{ section:'C18', professor:'Brenton Faber', days:['T'], start:'12:00', end:'13:50', location:'Stratton Hall 311', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3900_C20: {
    id:'HU3900_C20', code:'HU 3900', type:'HU39', credits:1,
    name:'INQ SEM: Music and Society',
    description:'Cat. I. This seminar serves as the culmination for a student\'s Humanities and Arts Requirement. Examines the relationship between music, culture, and social change.',
    prerequisites:[],
    sections:{ C:[{ section:'C20', professor:'Lucy Caplan', days:['T'], start:'14:00', end:'15:50', location:'Alden Hall B06 Janet Earle Room', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3900_C22: {
    id:'HU3900_C22', code:'HU 3900', type:'HU39', credits:1,
    name:'INQ SEM: Writing Suspense',
    description:'Cat. I. This seminar serves as the culmination for a student\'s Humanities and Arts Requirement. Explores the craft and cultural history of suspense writing.',
    prerequisites:[],
    sections:{ C:[{ section:'C22', professor:'TBA', days:['M'], start:'14:00', end:'15:50', location:'Salisbury Labs 124 Conference Room', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3900_C23: {
    id:'HU3900_C23', code:'HU 3900', type:'HU39', credits:1,
    name:'INQ SEM: Mic Check — The Rhetoric of Hip-Hop',
    description:'Cat. I. This seminar serves as the culmination for a student\'s Humanities and Arts Requirement. Analyzes hip-hop as rhetorical practice and cultural critique.',
    prerequisites:[],
    sections:{ C:[{ section:'C23', professor:'Lerie M. Gabriel', days:['R'], start:'12:00', end:'13:50', location:'Salisbury Labs 226 HUA Seminar Room', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3900_C24: {
    id:'HU3900_C24', code:'HU 3900', type:'HU39', credits:1,
    name:'INQ SEM: African Literature',
    description:'Cat. I. This seminar serves as the culmination for a student\'s Humanities and Arts Requirement. Explores African literary traditions and contemporary African writing.',
    prerequisites:[],
    sections:{ C:[{ section:'C24', professor:'TBA', days:[], start:null, end:null, location:'TBD', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3900_C26: {
    id:'HU3900_C26', code:'HU 3900', type:'HU39', credits:1,
    name:'INQ SEM: Fictions of Time Travel',
    description:'Cat. I. This seminar serves as the culmination for a student\'s Humanities and Arts Requirement. Examines time travel as a literary device and its philosophical implications.',
    prerequisites:[],
    sections:{ C:[{ section:'C26', professor:'TBA', days:['F'], start:'10:00', end:'11:50', location:'Salisbury Labs 124 Conference Room', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3900_C27: {
    id:'HU3900_C27', code:'HU 3900', type:'HU39', credits:1,
    name:'INQ SEM: Global Studies',
    description:'Cat. I. This seminar serves as the culmination for a student\'s Humanities and Arts Requirement. Examines global interconnections through humanistic and social inquiry.',
    prerequisites:[],
    sections:{ C:[{ section:'C27', professor:'Peter Hansen', days:['M'], start:'10:00', end:'11:50', location:'Salisbury Labs 226 HUA Seminar Room', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3900_C28: {
    id:'HU3900_C28', code:'HU 3900', type:'HU39', credits:1,
    name:'INQ SEM: Inquiry Seminar in Humanities',
    description:'Cat. I. This seminar serves as the culmination for a student\'s Humanities and Arts Requirement. Specific theme TBA.',
    prerequisites:[],
    sections:{ C:[{ section:'C28', professor:'TBA', days:[], start:null, end:null, location:'TBD', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3900_C29: {
    id:'HU3900_C29', code:'HU 3900', type:'HU39', credits:1,
    name:'INQ SEM: Soviet Space Program',
    description:'Cat. I. This seminar serves as the culmination for a student\'s Humanities and Arts Requirement. Explores the history, culture, and legacy of the Soviet space program.',
    prerequisites:[],
    sections:{ C:[{ section:'C29', professor:'Alexander Herbert', days:['M'], start:'12:00', end:'13:50', location:'Salisbury Labs 124 Conference Room', enrolled:'0/12', waitlist:'0/0' }] },
  },

  // HU 3910 — Practicum in HUA
  HU3910_C01: {
    id:'HU3910_C01', code:'HU 3910', type:'HU39', credits:1,
    name:'PRAC IN HUA: Sense of Place: Memory, History, and Imagination in Visual Media',
    description:'Cat. I. The practicum serves as the culmination for a student\'s Humanities and Arts Requirement. Students create spaces inspired by memory, history, or imagination using 3D modeling, digital painting, photography, animation, or mixed media.',
    prerequisites:[],
    sections:{ C:[{ section:'C01', professor:'Roshanak Bigonah', days:['T'], start:'12:00', end:'13:50', location:'Salisbury Labs 123 Computer Lab', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3910_C02: {
    id:'HU3910_C02', code:'HU 3910', type:'HU39', credits:1,
    name:'PRAC IN HUA: Visual Persuasion',
    description:'Cat. I. The practicum serves as the culmination for a student\'s Humanities and Arts Requirement. Explores visual rhetoric, design, and the use of imagery to persuade and communicate.',
    prerequisites:[],
    sections:{ C:[{ section:'C02', professor:'TBA', days:['F'], start:'12:00', end:'13:50', location:'TBD', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3910_C03: {
    id:'HU3910_C03', code:'HU 3910', type:'HU39', credits:1,
    name:'PRAC IN HUA: Music and Science Lab',
    description:'Cat. I. The practicum serves as the culmination for a student\'s Humanities and Arts Requirement. An interdisciplinary practicum exploring intersections of music and science.',
    prerequisites:[],
    sections:{ C:[{ section:'C03', professor:'David Ibbett', days:['R'], start:'10:00', end:'11:50', location:'Alden Hall B30 Music Technology Lab', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3910_C04: {
    id:'HU3910_C04', code:'HU 3910', type:'HU39', credits:1,
    name:'PRAC IN HUA: Arranging',
    description:'Cat. I. The practicum serves as the culmination for a student\'s Humanities and Arts Requirement. Focuses on musical arranging techniques for various ensembles and contexts.',
    prerequisites:[],
    sections:{ C:[{ section:'C04', professor:'Matthew Scinto', days:['W'], start:'12:00', end:'13:50', location:'Alden Hall B30 Music Technology Lab', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3910_C05: {
    id:'HU3910_C05', code:'HU 3910', type:'HU39', credits:1,
    name:'PRAC IN HUA: Adapt/Modded Musical Instruments',
    description:'Cat. I. The practicum serves as the culmination for a student\'s Humanities and Arts Requirement. Explores adapting and modifying musical instruments through creative practice.',
    prerequisites:[],
    sections:{ C:[{ section:'C05', professor:'TBA', days:[], start:null, end:null, location:'TBD', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3910_C07: {
    id:'HU3910_C07', code:'HU 3910', type:'HU39', credits:1,
    name:'PRAC IN HUA: Writing a Web Series',
    description:'Cat. I. The practicum serves as the culmination for a student\'s Humanities and Arts Requirement. Students write and develop a web series through creative writing and narrative craft.',
    prerequisites:[],
    sections:{ C:[{ section:'C07', professor:'Kevin Lewis', days:['T'], start:'12:00', end:'13:50', location:'Kaven Hall 202 Stats Computer Lab', enrolled:'0/12', waitlist:'0/0' }] },
  },
  HU3910_C08: {
    id:'HU3910_C08', code:'HU 3910', type:'HU39', credits:1,
    name:'PRAC IN HUA: 2D Design to 3D Sculpture',
    description:'Cat. I. The practicum serves as the culmination for a student\'s Humanities and Arts Requirement. Explores transforming 2D design concepts into 3D sculptural forms using digital tools.',
    prerequisites:[],
    sections:{ C:[{ section:'C08', professor:'Edward Gutierrez', days:['W'], start:'12:00', end:'13:50', location:'Fuller Labs 222 IMGD Computer Lab', enrolled:'0/12', waitlist:'0/0' }] },
  },
...
const TERM_AVAIL = {
  ...
  B:['INTL2100','INTL2210','INTL2320','INTL2910',
     ...
     'IQP','MQP'],
  C:['INTL1100','INTL2510','INTL2910',
     'HU3900_C01','HU3900_C01B','HU3900_C02','HU3900_C02B','HU3900_C04','HU3900_C05',
     'HU3900_C08','HU3900_C09','HU3900_C11','HU3900_C14','HU3900_C15','HU3900_C16',
     'HU3900_C17','HU3900_C18','HU3900_C20','HU3900_C22','HU3900_C23','HU3900_C24',
     'HU3900_C26','HU3900_C27','HU3900_C28','HU3900_C29',
     'HU3910_C01','HU3910_C02','HU3910_C03','HU3910_C04','HU3910_C05','HU3910_C07','HU3910_C08',
     'EN1219','EN1259','EN2219','EN2271','EN3219','EN3226',
     'DS1010','DS2010','DS3010',
     'WPE1003','WPE1009','WPE1012','WPE1018','WPE1019',
     'CS3043','CS3733','CS4341','CS4342','CS4433',
     'IQP','MQP'],
  D:['INTL2100','INTL2110','INTL2420',
